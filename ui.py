...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.canvas_text = self.canvas.create_text(150, 125, width=280, text="Some Question Text", fill=THEME_COLOR,
                                                   font=("Arial", 20, "italic"))
        self.score_label = Label(text=f"Score: {score}", bg=THEME_COLOR, fg="White", pady=20)
